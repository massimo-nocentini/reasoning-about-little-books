...
functor DeepMemo (
    ...
    in 
        ...
        fun deep_memo n = 
            if member n
            then let val sexp = find n in {result = sexp, memo_table = !memoization_table} end
            else let val sexp = deep_remember n in {result = sexp, memo_table = !memoization_table} end
